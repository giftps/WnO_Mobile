...
export const ArrowIosBackIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} width={26} height={26} fill="#fff" name="arrow-ios-back" />
);
...
export const NotificationsIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name="bell-outline" />
);

export const ThemeIcon = (style: ImageStyle): IconElement => (
...
export const SearchIcon = (style: ImageStyle): IconElement => {
  ...
  return (
    <Icon {...style} width={16} height={16} fill={"#777170"} name="search" />
  );
};

export const MessagesIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name="message-circle-outline" />
);

export const GroupIcon = (style: ImageStyle): IconElement => (
